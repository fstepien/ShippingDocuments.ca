...
<React.Fragment>  
    <div style={modalStyle}>
        <div style={modalContent}>
            <div className="top">
                <h1>Terms and Conditions</h1><button className="closeTermsBtn" >X</button>
            </div>
            <p className="terms">
     ...
     Health Disclaimer: 
     Any statements on this site or any materials or supplements distributed or sold by Favorite Food Diet has not been evaluated by the Food and Drug Administration. This product is not intended to diagnose, treat, cure or prevent any disease. If you are pregnant, nursing, taking medication, or have a history of heart conditions we suggest consulting with a physician before using any of our products. The results on all products are not typical and not everyone will experience these results.  	
     
     Customer Service email: support@favefooddiet.com 
     
     Return Policy: 
     In order to obtain your full refund, contact customer service by phone and obtain an RMA (Return Merchandise Authorization) number to place on your package. Write this number on the outside of the shipping package, and send the product back to our fulfillment center at the address listed below, within 60 days of the date you originally ordered the product. In order for your full refund to be processed the product must arrive at our fulfillment facility within 60 days of the original purchase date. You pay for return shipping. Once our fulfillment center has received the package and relayed the correct information to us, you will be issued a refund, plus a return fee if you qualify.  Your refund will be credited back to your bank account, and may take up to 3-5 business days to show in your statement, depending on the speed of the processing bank. 
     ...
     We attempt to ensure that the information on the Website is complete and accurate; however, this information may contain typographical errors, pricing errors, and other errors or inaccuracies. We assume no responsibility for such errors and omissions, and reserve the right to: 
     (i) revoke any offer stated on the Website; 
     (ii) correct any errors, inaccuracies or omissions; and 
     (iii) make changes to prices, content, promotions, product descriptions or specifications, or other information on the Website. 
     ...
     (iii) to respond to any Comments. You are and shall remain solely responsible for the content of any Comments you make. 
     
     10. Indemnification. 
     You agree to defend, indemnify and hold the Website, and its subsidiaries, affiliates, and their directors, officers, agents, members, shareholders, co-branders or other partners, employees, and Ad Partners harmless from any liabilities, losses, actions, damages, claims or demands, including reasonable attorneys' fees, costs and expenses, made by any third party directly or indirectly relating to or arising out of 
     (a) content you provide to the Website or otherwise transmit or obtain through the Service, 
     ...
     14. Arbitration. 
     All disputes arising out of or relating to this TOS (including its formation, performance or alleged breach) or your use of the Website will be exclusively resolved under confidential binding arbitration held in accordance with the Rules of the American Arbitration Association. The arbitrator's award will be binding and may be entered as a judgment in any court of competent jurisdiction. To the fullest extent permitted by applicable law, no arbitration under this TOS will be joined to an arbitration involving any other party subject to this TOS, whether through class arbitration proceedings or otherwise. Notwithstanding the foregoing, we will have the right to seek injunctive or other equitable relief in state or federal court located in Minneapolis, MN to enforce this TOS or prevent an infringement of a third party's rights. In the event equitable relief is sought, each party hereby irrevocably submits to the personal jurisdiction of such court. 
     ...
     These terms and conditions were last updated on 09-29-2017.
     
     Copyright © 2017 favefooddiet.com — All rights reserved.
            </p> 
            <div className="bottom">
                <form >
                    <input type="checkbox"/>
                    <span>I agree to the terms and conditions</span> <br/>
                    <button class="termsSubmitBtn">Print</button>
                </form>
            </div>
        </div>
    </div>      
