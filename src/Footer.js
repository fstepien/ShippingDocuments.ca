      ...
      <footer>
        <div className="footer container mt50">
          <ul>
            <li />
            <a
              href="mailto:contact@shippingdocuments.ca"
              target="_blank"
            ...
            <li>
              <a
                href="https://www.tc.gc.ca/eng/tdg/page-1288.html"
                rel="noopener noreferrer"
                target="_blank"
              >
                TDG Regulations
            ...
            <li>
              <a onClick={this.showTermsOnly}>Terms</a> and{" "}
              <a onClick={this.togglePrivacy}>Privacy Policy</a>
            </li>
